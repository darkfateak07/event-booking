          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Discover and book tickets for the most exciting events, conferences, and festivals around the world. 
            ...
            <div className="space-y-4">
              ...
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm"
                />
                <motion.button
